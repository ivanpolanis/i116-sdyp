...
// Retorna el valor de la matriz en la posicion fila y columna segun el orden
// que este ordenada
...
// Establece el valor de la matriz en la posicion fila y columna segun el orden
// que este ordenada
...
int main(int argc, char *argv[]) {
  ...
  // Inicializa las matrices A y B en 1, el resultado sera una matriz con todos
  // sus valores en N
  for (i = 0; i < N; i++) {
    for (j = 0; j < N; j++) {
  ...
  // Solution without function overhead
  // for (i = 0; i < N; i++) {
  //   for (j = 0; j < N; j++) {
  //     C[i * N + j] = 0;
  //     for (k = 0; k < N; k++) {
  ...
  // Solution without function overhead and B stored by columns
  for (i = 0; i < N; i++) {
    for (j = 0; j < N; j++) {
      C[i * N + j] = 0;
      for (k = 0; k < N; k++) {
