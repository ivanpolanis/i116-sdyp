// Dados dos arrays (U y V) de vectores en R^3. Para cada posición se realiza el
// producto vectorial uno a uno, es decir para una posicion i, W[i] = U[i] X
// V[i] Sin embargo, cada array estan separado en 3 array, uno por cada
...
void inicializarArrays(double *Ui, double *Uj, double *Uk, double *Vi,
                       double *Vj, double *Vk, unsigned long N) {
  unsigned long p;
...
void productoVectorialArrays(double *Ui, double *Uj, double *Uk, double *Vi,
                             double *Vj, double *Vk, double *Wi, double *Wj,
                             double *Wk, unsigned long N) {
  unsigned long p;
